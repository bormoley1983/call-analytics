...
class TestKeywordConfigFailures:
    ...
    def test_keyword_drill_down_before_materialization_returns_409(self, api_client) -> None:
...
class TestUnknownKeywordIds:
    ...
    def test_unknown_keyword_id_returns_stable_error(self, api_client) -> None:
        ...
        assert response.status_code != 500, \
            "Unknown keyword should not cause 500 error"
...
class TestRequestValidation:
    ...
    def test_report_with_invalid_date_format(self, api_client) -> None:
        ...
        response = api_client.get("/reports/overall", params={
            "call_date_from": "not-a-date"
        })
